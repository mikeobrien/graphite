...
namespace Tests.Unit.Writers.Bender
{
    ...
    public class JsonWriterTests
    {
            ...
            string acceptType, bool applies)
        {
            ...
            new Graphite.Bender.JsonWriter(new Options()).AppliesTo(context).ShouldEqual(applies);
        }
        ...
        public async Task Should_write_json()
        {
            ...
            var response = await new Graphite.Bender.JsonWriter(new Options()).Write(context);
