...
namespace Tests.Unit.Writers.Newtonsoft.Json
{
    [TestFixture]
    public class JsonWriterTests
    {
            ...
            string acceptType, bool applies)
        {
            ...
            new Graphite.Newtonsoft.Json.JsonWriter(new JsonSerializerSettings())
        ...
        public async Task Should_write_json()
        {
            ...
            var response = await new Graphite.Newtonsoft.Json
                .JsonWriter(new JsonSerializerSettings()).Write(context);
