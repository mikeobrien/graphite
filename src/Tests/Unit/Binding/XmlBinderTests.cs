...
namespace Tests.Unit.Binding
{
    ...
    public class XmlBinderTests
    {
            ...
            [Values(true, false)] bool hasParameters)
        {
            var requestGraph = RequestGraph
                .CreateFor<Handler>(h => h.Params(null, null, null))
                    .WithRequestData("<fark><param1>value1</param1><param2>value2</param2></fark>")
            ...
            new XmlBinder(requestGraph.ValueMappers)
        ...
        [Test]
        public void Should_only_apply_if_the_content_type_is_xml(
        ...
        [Test]
        public async Task Should_bind_xxml_values()
        {
            var requestGraph = RequestGraph
                .CreateFor<Handler>(h => h.Params(null, null, null))
                    .WithRequestData(
                        "<fark>" +
                            ...
                            "<param2><param3>value3</param3></param2>" +
                        "</fark>")
                    .AddParameter("param1")
                    .AddParameter("param2")
                    .AddValueMapper1(x => x.Values.First());

            var binder = new XmlBinder(requestGraph.ValueMappers);
